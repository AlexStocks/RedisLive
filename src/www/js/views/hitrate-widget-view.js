var HitRateWidget = BaseWidget.extend({

    initialize : function() {

      this.Name = "HitRate Widget"

      this.init()

      // templates
      var templateSelector = "#hitrate-widget-template"
      ...
      // chart
      this.chart = new google.visualization.AreaChart($("#hitrate-widget-chart").empty().get(0))
      this.dataTable = new google.visualization.DataTable()
      this.dataTable.addColumn('datetime', 'datetime')
      this.dataTable.addColumn('number', 'HitRate')
    }
