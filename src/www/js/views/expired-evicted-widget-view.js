var ExpiredEvictedWidget = BaseWidget.extend({

    initialize : function() {

      this.Name = "ExpiredEvicted Widget"

      this.init()

      // templates
      var templateSelector = "#expired-evicted-widget-template"
      ...
      // chart
      this.chart = new google.visualization.LineChart($("#expired-evicted-widget-chart").empty().get(0))
      this.dataTable = new google.visualization.DataTable()
      this.dataTable.addColumn('datetime', 'datetime')
      this.dataTable.addColumn('number', 'expired')
      this.dataTable.addColumn('number', 'evicted')
    }
