var KeySpaceWidget = BaseWidget.extend({
    ...
    initialize : function() {
      ...
      // chart
      this.chart = new google.visualization.LineChart($("#keyspace-widget-chart").empty().get(0))
      this.dataTable = new google.visualization.DataTable()
      this.dataTable.addColumn('datetime', 'datetime')
      this.dataTable.addColumn('number', 'persists')
      this.dataTable.addColumn('number', 'expires')
    }
