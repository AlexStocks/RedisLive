...
var App = {
    ...
    init: function() {
        ...
        var hitRateWidget = new HitRateWidget({
            el : $("#hitrate-widget-placeholder")
          , model : new HitRateWidgetModel()
        })
        ...
        var expiredevictedWidget = new ExpiredEvictedWidget({
            el : $("#expired-evicted-widget-placeholder")
          , model : new ExpiredEvictedWidgetModel()
        })
